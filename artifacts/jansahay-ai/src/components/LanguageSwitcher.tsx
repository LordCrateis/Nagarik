...
export function LanguageSwitcher() {
  ...
  return <div translate="no" className="relative" onClick={(event) => event.stopPropagation()}>
    ...
    {open && <div role="listbox" className="absolute right-0 z-40 mt-2 grid max-h-[min(28rem,calc(100dvh-5rem))] w-56 grid-cols-1 overflow-y-auto rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-1.5 shadow-[0_18px_45px_hsl(var(--foreground)/.18)] animate-in fade-in-0 zoom-in-95">
