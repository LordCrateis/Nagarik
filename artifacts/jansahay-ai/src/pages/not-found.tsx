  ...
  return (
    <div className="min-h-[100dvh] bg-[hsl(var(--background))] px-5 py-6">
      ...
      <main className="mx-auto flex max-w-5xl flex-col items-center px-4 py-28 text-center">
        ...
        <p className="mt-4 max-w-md text-sm leading-relaxed text-[hsl(var(--muted-foreground))]">The link may have moved. Head back to Nagarik and start from a clearer place.</p>
